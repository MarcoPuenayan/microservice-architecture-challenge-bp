package com.pichincha.account.transaction.infrastructure.exception;

import static com.pichincha.account.transaction.domain.utils.Constants.EXCEPTION_CONSTRAINT_VIOLATION_TITTLE;
import static com.pichincha.account.transaction.domain.utils.Constants.EXCEPTION_DETAIL;
import static com.pichincha.account.transaction.domain.utils.Constants.EXCEPTION_MESSAGE_VALIDATION;

import com.pichincha.account.transaction.infrastructure.exception.error.ErrorErrors;
import com.pichincha.account.transaction.infrastructure.exception.error.Error;
